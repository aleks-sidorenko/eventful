...
module Eventium.Store.DynamoDB.DynamoJSON
...
valueToAttributeValue (Object v)
  | HM.null v = attributeValue & avS ?~ "__eventium-dynamodb-empty-object__"
...
attributeValueToValue av
  | Just "__eventium-dynamodb-empty-object__" <- av ^. avS = Object HM.empty
